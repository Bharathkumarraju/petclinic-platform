...
# PostgreSQL Database Configuration for MIS
# This module creates database roles, schemas, and access control
module "rds_mis_config" {
  ...
  database_name = "mis"
  schema_name   = "mis_dashboard"

  # RDS instance connection details
  master_username      = module.rds_mis.db_instance_username
  db_instance_endpoint = module.rds_mis.db_instance_address
