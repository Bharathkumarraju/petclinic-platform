...
# PostgreSQL Database Configuration for DSP
# This module creates database roles, schemas, and access control
module "rds_dsp_config" {
  ...
  database_name = "dsp"
  schema_name   = "dsp_waterfall"

  # RDS instance connection details
  master_username      = module.rds_dsp.db_instance_username
  db_instance_endpoint = module.rds_dsp.db_instance_address
