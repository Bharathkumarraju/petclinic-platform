...
# PostgreSQL Database Configuration for atrp
# This module creates database roles, schemas, and access control
module "rds_atrp_config" {
  ...
  database_name = "eprime"
  schema_name   = "eprime"

  # RDS instance connection details
  master_username      = module.rds_atrp.db_instance_username
  db_instance_endpoint = module.rds_atrp.db_instance_address
