...
# # data "aws_db_instance" "acerreport" {
# #   db_instance_identifier = local.db_identifier
# # }

# data "aws_secretsmanager_secret_version" "acerreport_master" {
#   secret_id = data.aws_db_instance.acerreport.master_user_secret[0].secret_arn
# }
