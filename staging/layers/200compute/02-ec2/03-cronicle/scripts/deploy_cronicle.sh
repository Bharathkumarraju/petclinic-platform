...
AWS_S3_BUCKET_NAME='abex-cronicle-bucket-uat-sin'
...
# load configuration
cat >/opt/cronicle/conf/config.json <<EOF
{
    "base_app_url": "http://cronicle.xabx.net:3012",
    "email_from": "admin@abaxx.exchange",
    "smtp_hostname": "cronicle.xabx.net",
    "smtp_port": 25,
    "secret_key": "CronicleSecretKeyUAT",
...
# # setup s3 storage (for master node only)
